...
public class CustomDatePicker {
    ...
    public void finish() {
        ...
        year_pv.setOnClickListener(null);
        month_pv.setOnClickListener(null);
        day_pv.setOnClickListener(null);
        hour_pv.setOnClickListener(null);
        minute_pv.setOnClickListener(null);
        ...
        tv_cancle.setOnClickListener(null);
        tv_select.setOnClickListener(null);
    }
...
//            MyLog.i("DatePicker", "startDate=" + startDate + " endDate=" + endDate);
            try {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.national_custom_date_picker);
...
//        MyLog.i("DatePicker", "startYear=" + startYear
...
//        minute_pv.setData(minute);
    ...
    boolean isMiuteEnable =  false;
    public void setMiuteEnable(boolean enable){
        isMiuteEnable = enable;
...
//            selectedCalender.set(Calendar.HOUR_OF_DAY, Integer.parseInt(hour.get(0)));
            hour_pv.setData(hour);
            if (Integer.parseInt(hour.get(0)) == 0) {

                int pos = hour.size();
                if(pos>0){
                    pos--;
                }
                selectedCalender.set(Calendar.HOUR_OF_DAY, Integer.parseInt(hour.get(pos)));
                hour_pv.setSelected(pos);
//                selectedCalender.set(Calendar.HOUR_OF_DAY, Integer.parseInt(hour.get(12)));
//                hour_pv.setSelected(12);
            } else {
...
//        }
        ...
        minute_pv.setData(minute);
        minute_pv.setCanScroll(isMiuteEnable);
    }
...
//            }
            ...
            if (str.length == 2) {
                ...
                if ((scrollUnits & SCROLL_TYPE.HOUR.value) == SCROLL_TYPE.HOUR.value) {
                    ...
                    } else if (selectedYear == startYear && selectedMonth == startMonth && selectedDay == startDay) {
                        for (int i = startHour; i <= MAX_HOUR; i++) {
                            hour.add(formatTimeUnit(i));
                        }
                    } else if (selectedYear == endYear && selectedMonth == endMonth && selectedDay == endDay) {
                ...
                if ((scrollUnits & SCROLL_TYPE.MINUTE.value) == SCROLL_TYPE.MINUTE.value) {
                    ...
                    else if (selectedYear == startYear && selectedMonth == startMonth && selectedDay == startDay && selectedHour == startHour) {
                        for (int i = startMinute; i <= MAX_MINUTE; i++) {
                            minute.add(formatTimeUnit(i));
                        }
                    } else if (selectedYear == endYear && selectedMonth == endMonth && selectedDay == endDay && selectedHour == endHour) {
