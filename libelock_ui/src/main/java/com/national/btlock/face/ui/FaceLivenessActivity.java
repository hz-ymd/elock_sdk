 ...
 */
package com.national.btlock.face.ui;
...
import com.national.btlock.face.ui.utils.BrightnessUtils;
import com.national.btlock.face.ui.utils.CameraUtils;
import com.national.btlock.face.ui.utils.VolumeUtils;
import com.national.btlock.face.ui.widget.FaceDetectRoundView;
...
//                Gravity.CENTER_VERTICAL | Gravity.CENTER_HORIZONTAL);
    ...
    public void initPermission() {
        boolean cameraSatePermission =
                ActivityCompat.checkSelfPermission(FaceLivenessActivity.this,
    ...
    String[] permsion = new String[]{Manifest.permission.CAMERA};

    private void requestPermission() {
        ActivityCompat.requestPermissions(FaceLivenessActivity.this
                , permsion
                , REQUEST_PERMISSION);
    ...
    private synchronized void showDeniedDialog() {
        ...
        AlertDialog dlg = new AlertDialog.Builder(FaceLivenessActivity.this)
