...
//        outStream.close();
    ...
    public static byte[] bitmapToByte(String path, Bitmap.CompressFormat format,
                                      int imgQuality) {
//        long start = System.currentTimeMillis();
        ...
        b.compress(format, imgQuality, o);
        data = o.toByteArray();
//        TestLog.netE(TAG, "bitmapToByte" + (System.currentTimeMillis() - start));
        return data;
    }
